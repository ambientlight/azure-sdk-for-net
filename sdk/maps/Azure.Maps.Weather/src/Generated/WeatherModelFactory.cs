...
namespace Azure.Maps.Weather
{
    ...
    {
        /// <summary> Initializes new instance of HourlyForecastResponse class. </summary>
        ...
        public static HourlyForecastResponse HourlyForecastResponse(IReadOnlyList<HourlyForecast> forecasts = default)
        {
            forecasts ??= new List<HourlyForecast>();
            return new HourlyForecastResponse(forecasts);
        }

        /// <summary> Initializes new instance of HourlyForecast class. </summary>
        ...
        public static HourlyForecast HourlyForecast(string date = default, int? iconCode = default, string iconPhrase = default, bool? hasPrecipitation = default, bool? isDaylight = default, WeatherUnit temperature = default, WeatherUnit realFeelTemperature = default, WeatherUnit wetBulbTemperature = default, WeatherUnit dewPoint = default, WindDetails wind = default, WindDetails windGust = default, int? relativeHumidity = default, WeatherUnit visibility = default, WeatherUnit ceiling = default, int? uvIndex = default, string uvIndexPhrase = default, int? precipitationProbability = default, int? rainProbability = default, int? snowProbability = default, int? iceProbability = default, WeatherUnit totalLiquid = default, WeatherUnit rain = default, WeatherUnit snow = default, WeatherUnit ice = default, int? cloudCover = default)
        {
        ...
        /// <summary> Initializes new instance of WeatherUnit class. </summary>
        ...
        public static WeatherUnit WeatherUnit(float? value = default, string unit = default, int? unitType = default)
        {
            return new WeatherUnit(value, unit, unitType);
        }

        /// <summary> Initializes new instance of WindDetails class. </summary>
        ...
        public static WindDetails WindDetails(WindDirection direction = default, WindSpeed speed = default)
        {
            return new WindDetails(direction, speed);
        }

        /// <summary> Initializes new instance of WindDirection class. </summary>
        ...
        public static WindDirection WindDirection(int? degrees = default, string localizedDescription = default)
        {
            return new WindDirection(degrees, localizedDescription);
        }

        /// <summary> Initializes new instance of WindSpeed class. </summary>
        ...
        public static WindSpeed WindSpeed(float? value = default, string unit = default, int? unitType = default)
        {
            return new WindSpeed(value, unit, unitType);
        }

        /// <summary> Initializes new instance of MinuteForecastResponse class. </summary>
        ...
        public static MinuteForecastResponse MinuteForecastResponse(MinuteForecastSummary summary = default, IReadOnlyList<IntervalSummary> intervalSummaries = default, IReadOnlyList<ForecastInterval> intervals = default)
        {
            intervalSummaries ??= new List<IntervalSummary>();
            intervals ??= new List<ForecastInterval>();
            return new MinuteForecastResponse(summary, intervalSummaries, intervals);
        }

        /// <summary> Initializes new instance of MinuteForecastSummary class. </summary>
        ...
        public static MinuteForecastSummary MinuteForecastSummary(string briefPhrase60 = default, string shortPhrase = default, string briefPhrase = default, string longPhrase = default, int? iconCode = default)
        {
            return new MinuteForecastSummary(briefPhrase60, shortPhrase, briefPhrase, longPhrase, iconCode);
        }

        /// <summary> Initializes new instance of IntervalSummary class. </summary>
        ...
        public static IntervalSummary IntervalSummary(int? startMinute = default, int? endMinute = default, int? totalMinutes = default, string shortPhrase = default, string briefPhrase = default, string longPhrase = default, int? iconCode = default)
        {
            return new IntervalSummary(startMinute, endMinute, totalMinutes, shortPhrase, briefPhrase, longPhrase, iconCode);
        }

        /// <summary> Initializes new instance of ForecastInterval class. </summary>
        ...
        public static ForecastInterval ForecastInterval(string startTime = default, int? minute = default, double? dbz = default, string shortPhrase = default, string threshold = default, ColorValue color = default, ColorValue simplifiedColor = default, string precipitationType = default, int? iconCode = default, int? cloudCover = default)
        {
        ...
        /// <summary> Initializes new instance of ColorValue class. </summary>
        ...
        /// <summary> Initializes new instance of QuarterDayForecastResponse class. </summary>
        ...
        public static QuarterDayForecastResponse QuarterDayForecastResponse(IReadOnlyList<QuarterDayForecast> forecasts = default)
        {
            forecasts ??= new List<QuarterDayForecast>();
            return new QuarterDayForecastResponse(forecasts);
        }

        /// <summary> Initializes new instance of QuarterDayForecast class. </summary>
        /// <param name="date"> Date and time of the forecast in ISO 8601 format, for example, 2019-10-27T19:39:57-08:00. </param>
        ...
        public static QuarterDayForecast QuarterDayForecast(string date = default, string effectiveDate = default, DayQuarter? quarter = default, int? iconCode = default, string iconPhrase = default, string phrase = default, WeatherUnitRange temperature = default, WeatherUnitRange realFeelTemperature = default, WeatherUnit dewPoint = default, int? relativeHumidity = default, WindDetails wind = default, WindDetails windGust = default, WeatherUnit visibility = default, int? cloudCover = default, bool? hasPrecipitation = default, string precipitationType = default, string precipitationIntensity = default, int? precipitationProbability = default, int? thunderstormProbability = default, WeatherUnit totalLiquid = default, WeatherUnit rain = default, WeatherUnit snow = default, WeatherUnit ice = default)
        {
        ...
        /// <summary> Initializes new instance of WeatherUnitRange class. </summary>
        ...
        public static WeatherUnitRange WeatherUnitRange(WeatherUnit minimum = default, WeatherUnit maximum = default)
        {
            return new WeatherUnitRange(minimum, maximum);
        }

        /// <summary> Initializes new instance of CurrentConditionsResponse class. </summary>
        ...
        public static CurrentConditionsResponse CurrentConditionsResponse(IReadOnlyList<CurrentConditions> results = default)
        {
            results ??= new List<CurrentConditions>();
            return new CurrentConditionsResponse(results);
        }

        /// <summary> Initializes new instance of CurrentConditions class. </summary>
        ...
        public static CurrentConditions CurrentConditions(string dateTime = default, string phrase = default, int? iconCode = default, bool? hasPrecipitation = default, bool? isDayTime = default, WeatherUnit temperature = default, WeatherUnit realFeelTemperature = default, WeatherUnit realFeelTemperatureShade = default, int? relativeHumidity = default, WeatherUnit dewPoint = default, WindDetails wind = default, WindDetails windGust = default, int? uvIndex = default, string uvIndexPhrase = default, WeatherUnit visibility = default, string obstructionsToVisibility = default, int? cloudCover = default, WeatherUnit ceiling = default, WeatherUnit pressure = default, PressureTendency pressureTendency = default, WeatherUnit past24HourTemperatureDeparture = default, WeatherUnit apparentTemperature = default, WeatherUnit windChillTemperature = default, WeatherUnit wetBulbTemperature = default, PrecipitationSummary precipitationSummary = default, TemperatureSummary temperatureSummary = default)
        {
        ...
        /// <summary> Initializes new instance of PressureTendency class. </summary>
        ...
        public static PressureTendency PressureTendency(string localizedDescription = default, string code = default)
        {
            return new PressureTendency(localizedDescription, code);
        }

        /// <summary> Initializes new instance of PrecipitationSummary class. </summary>
        ...
        public static PrecipitationSummary PrecipitationSummary(WeatherUnit pastHour = default, WeatherUnit past3Hours = default, WeatherUnit past6Hours = default, WeatherUnit past9Hours = default, WeatherUnit past12Hours = default, WeatherUnit past18Hours = default, WeatherUnit past24Hours = default)
        {
            return new PrecipitationSummary(pastHour, past3Hours, past6Hours, past9Hours, past12Hours, past18Hours, past24Hours);
        }

        /// <summary> Initializes new instance of TemperatureSummary class. </summary>
        ...
        public static TemperatureSummary TemperatureSummary(TemperatureSummaryPast6Hours past6Hours = default, TemperatureSummaryPast12Hours past12Hours = default, TemperatureSummaryPast24Hours past24Hours = default)
        {
            return new TemperatureSummary(past6Hours, past12Hours, past24Hours);
        }

        /// <summary> Initializes new instance of TemperatureSummaryPast6Hours class. </summary>
        /// <param name="minimum"> minimum. </param>
        /// <param name="maximum"> maximum. </param>
        /// <returns> A new <see cref="Models.TemperatureSummaryPast6Hours"/> instance for mocking. </returns>
        public static TemperatureSummaryPast6Hours TemperatureSummaryPast6Hours(WeatherUnit minimum = default, WeatherUnit maximum = default)
        {
            return new TemperatureSummaryPast6Hours(minimum, maximum);
        }

        /// <summary> Initializes new instance of TemperatureSummaryPast12Hours class. </summary>
        /// <param name="minimum"> minimum. </param>
        /// <param name="maximum"> maximum. </param>
        /// <returns> A new <see cref="Models.TemperatureSummaryPast12Hours"/> instance for mocking. </returns>
        public static TemperatureSummaryPast12Hours TemperatureSummaryPast12Hours(WeatherUnit minimum = default, WeatherUnit maximum = default)
        {
            return new TemperatureSummaryPast12Hours(minimum, maximum);
        }

        /// <summary> Initializes new instance of TemperatureSummaryPast24Hours class. </summary>
        /// <param name="minimum"> minimum. </param>
        /// <param name="maximum"> maximum. </param>
        /// <returns> A new <see cref="Models.TemperatureSummaryPast24Hours"/> instance for mocking. </returns>
        public static TemperatureSummaryPast24Hours TemperatureSummaryPast24Hours(WeatherUnit minimum = default, WeatherUnit maximum = default)
        {
            return new TemperatureSummaryPast24Hours(minimum, maximum);
        }

        /// <summary> Initializes new instance of DailyForecastResponse class. </summary>
        ...
        public static DailyForecastResponse DailyForecastResponse(DailyForecastSummary summary = default, IReadOnlyList<DailyForecast> forecasts = default)
        {
            forecasts ??= new List<DailyForecast>();
            return new DailyForecastResponse(summary, forecasts);
        }

        /// <summary> Initializes new instance of DailyForecastSummary class. </summary>
        ...
        public static DailyForecastSummary DailyForecastSummary(string startDate = default, string endDate = default, int? severity = default, string phrase = default, string category = default)
        {
            return new DailyForecastSummary(startDate, endDate, severity, phrase, category);
        }

        /// <summary> Initializes new instance of DailyForecast class. </summary>
        ...
        public static DailyForecast DailyForecast(string date = default, WeatherUnitRange temperature = default, WeatherUnitRange realFeelTemperature = default, WeatherUnitRange realFeelTemperatureShade = default, float? hoursOfSun = default, DegreeDaySummary degreeDaySummary = default, IReadOnlyList<AirAndPollen> airAndPollen = default, DayOrNight day = default, DayOrNight night = default, IReadOnlyList<string> sources = default)
        {
            airAndPollen ??= new List<AirAndPollen>();
            sources ??= new List<string>();
            return new DailyForecast(date, temperature, realFeelTemperature, realFeelTemperatureShade, hoursOfSun, degreeDaySummary, airAndPollen, day, night, sources);
        }

        /// <summary> Initializes new instance of DegreeDaySummary class. </summary>
        ...
        public static DegreeDaySummary DegreeDaySummary(WeatherUnit heating = default, WeatherUnit cooling = default)
        {
            return new DegreeDaySummary(heating, cooling);
        }

        /// <summary> Initializes new instance of AirAndPollen class. </summary>
        ...
        public static AirAndPollen AirAndPollen(string name = default, int? value = default, string category = default, int? categoryValue = default, string type = default)
        {
            return new AirAndPollen(name, value, category, categoryValue, type);
        }

        /// <summary> Initializes new instance of DayOrNight class. </summary>
        /// <param name="iconCode"> Numeric value representing an image that displays the `iconPhrase`. Please refer to [Weather Service Concepts](https://aka.ms/AzureMapsWeatherConcepts) for details. </param>
        /// <param name="iconPhrase"> Phrase description of the icon. Displayed in specified language. For example, &apos;Sunny&apos;. </param>
        ...
        public static DayOrNight DayOrNight(int? iconCode = default, string iconPhrase = default, LocalSource localSource = default, bool? hasPrecipitation = default, string precipitationType = default, string precipitationIntensity = default, string shortPhrase = default, string longPhrase = default, int? precipitationProbability = default, int? thunderstormProbability = default, int? rainProbability = default, int? snowProbability = default, int? iceProbability = default, WindDetails wind = default, WindDetails windGust = default, WeatherUnit totalLiquid = default, WeatherUnit rain = default, WeatherUnit snow = default, WeatherUnit ice = default, float? hoursOfPrecipitation = default, float? hoursOfRain = default, float? hoursOfSnow = default, float? hoursOfIce = default, int? cloudCover = default)
        {
        ...
        /// <summary> Initializes new instance of LocalSource class. </summary>
        ...
        /// <summary> Initializes new instance of WeatherAlongRouteResponse class. </summary>
        ...
        public static WeatherAlongRouteResponse WeatherAlongRouteResponse(WeatherAlongRouteSummary summary = default, IReadOnlyList<WeatherWaypoint> waypoints = default)
        {
            waypoints ??= new List<WeatherWaypoint>();
            return new WeatherAlongRouteResponse(summary, waypoints);
        }

        /// <summary> Initializes new instance of WeatherAlongRouteSummary class. </summary>
        /// <param name="iconCode"> Numeric value representing an image that displays the `iconPhrase`. Please refer to [Weather Service Concepts](https://aka.ms/AzureMapsWeatherConcepts) for details. </param>
        ...
        public static WeatherAlongRouteSummary WeatherAlongRouteSummary(int? iconCode = default, WeatherHazards hazards = default)
        {
            return new WeatherAlongRouteSummary(iconCode, hazards);
        }

        /// <summary> Initializes new instance of WeatherHazards class. </summary>
        ...
        public static WeatherHazards WeatherHazards(int? maxHazardIndex = default, IReadOnlyList<HazardDetail> hazardDetails = default)
        {
            hazardDetails ??= new List<HazardDetail>();
            return new WeatherHazards(maxHazardIndex, hazardDetails);
        }

        /// <summary> Initializes new instance of HazardDetail class. </summary>
        ...
        public static HazardDetail HazardDetail(int? hazardIndex = default, string hazardCode = default, string shortPhrase = default)
        {
            return new HazardDetail(hazardIndex, hazardCode, shortPhrase);
        }

        /// <summary> Initializes new instance of WeatherWaypoint class. </summary>
        /// <param name="iconCode"> Numeric value representing an image that displays the `iconPhrase`. Please refer to [Weather Service Concepts](https://aka.ms/AzureMapsWeatherConcepts) for details. </param>
        /// <param name="shortPhrase"> A displayable short phrase describing the forecasted conditions and precipitation intensity/type. </param>
        /// <param name="isDayTime"> Indicates the time of the day. True indicates &apos;day&apos;,&apos;, false indicates &apos;night. </param>
        /// <param name="cloudCover"> Percent representing cloud cover. </param>
        ...
        public static WeatherWaypoint WeatherWaypoint(int? iconCode = default, string shortPhrase = default, bool? isDayTime = default, int? cloudCover = default, WeatherUnit temperature = default, WindDetails wind = default, WindDetails windGust = default, WeatherAlongRoutePrecipitation precipitation = default, int? lightningCount = default, SunGlare sunGlare = default, WeatherHazards hazards = default, IReadOnlyList<WeatherNotification> notifications = default)
        {
            notifications ??= new List<WeatherNotification>();
            return new WeatherWaypoint(iconCode, shortPhrase, isDayTime, cloudCover, temperature, wind, windGust, precipitation, lightningCount, sunGlare, hazards, notifications);
        }

        /// <summary> Initializes new instance of WeatherAlongRoutePrecipitation class. </summary>
        ...
        /// <summary> Initializes new instance of SunGlare class. </summary>
        ...
        /// <summary> Initializes new instance of WeatherNotification class. </summary>
        ...
        public static WeatherNotification WeatherNotification(string type = default, int? hazardIndex = default, string hazardCode = default, string shortPhrase = default)
        {
            return new WeatherNotification(type, hazardIndex, hazardCode, shortPhrase);
        }

        /// <summary> Initializes new instance of SevereWeatherAlertsResponse class. </summary>
        ...
        public static SevereWeatherAlertsResponse SevereWeatherAlertsResponse(IReadOnlyList<SevereWeatherAlert> results = default)
        {
            results ??= new List<SevereWeatherAlert>();
            return new SevereWeatherAlertsResponse(results);
        }

        /// <summary> Initializes new instance of SevereWeatherAlert class. </summary>
        ...
        public static SevereWeatherAlert SevereWeatherAlert(string countryCode = default, int? alertId = default, SevereWeatherAlertDescription description = default, string category = default, int? priority = default, string @class = default, string level = default, string source = default, int? sourceId = default, string disclaimer = default, IReadOnlyList<AlertArea> alertAreas = default)
        {
            alertAreas ??= new List<AlertArea>();
            return new SevereWeatherAlert(countryCode, alertId, description, category, priority, @class, level, source, sourceId, disclaimer, alertAreas);
        }

        /// <summary> Initializes new instance of SevereWeatherAlertDescription class. </summary>
        ...
        public static SevereWeatherAlertDescription SevereWeatherAlertDescription(string localized = default, string english = default)
        {
            return new SevereWeatherAlertDescription(localized, english);
        }

        /// <summary> Initializes new instance of AlertArea class. </summary>
        ...
        public static AlertArea AlertArea(string name = default, string summary = default, string startTime = default, string endTime = default, LatestStatus latestStatus = default, string alertDetails = default, string alertDetailsLanguageCode = default)
        {
            return new AlertArea(name, summary, startTime, endTime, latestStatus, alertDetails, alertDetailsLanguageCode);
        }

        /// <summary> Initializes new instance of LatestStatus class. </summary>
        ...
        /// <summary> Initializes new instance of DailyIndicesResponse class. </summary>
        ...
        public static DailyIndicesResponse DailyIndicesResponse(IReadOnlyList<DailyIndex> results = default)
        {
            results ??= new List<DailyIndex>();
            return new DailyIndicesResponse(results);
        }

        /// <summary> Initializes new instance of DailyIndex class. </summary>
        ...
        public static DailyIndex DailyIndex(string indexName = default, int? indexId = default, string dateTime = default, float? value = default, string category = default, int? categoryValue = default, bool? @ascending = default, string description = default)
        {
