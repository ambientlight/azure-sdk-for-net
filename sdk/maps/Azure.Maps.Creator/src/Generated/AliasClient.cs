...
namespace Azure.Maps.Creator
{
    ...
    public partial class AliasClient
    {
        ...
        public AliasClient(TokenCredential credential, Geography? geography = null, CreatorClientOptions options = null)
        {
            if (credential == null)
            {
        ...
        /// <param name="geography"> This parameter specifies where the Azure Maps Creator resource is located.  Valid values are us and eu. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public AliasClient(AzureKeyCredential credential, Geography? geography = null, CreatorClientOptions options = null)
        {
            if (credential == null)
            {
                throw new ArgumentNullException(nameof(credential));
        ...
        /// <param name="geography"> This parameter specifies where the Azure Maps Creator resource is located.  Valid values are us and eu. </param>
        internal AliasClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Geography? geography = null)
        {
