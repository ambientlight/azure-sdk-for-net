...
namespace Azure.Maps.Data
{
    internal partial class DataRestClient
    {
        ...
        public DataRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Geography? geography = null, string xMsClientId = null, string apiVersion = "2.0")
        {
        ...
        internal HttpMessage CreateUpdatePreviewRequest(string uniqueDataId, Stream updateContent, string uploadDataDescription)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<ResponseWithHeaders<DataUpdatePreviewHeaders>> UpdatePreviewAsync(string uniqueDataId, Stream updateContent, string uploadDataDescription = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="uniqueDataId"/> or <paramref name="updateContent"/> is null. </exception>
        public ResponseWithHeaders<DataUpdatePreviewHeaders> UpdatePreview(string uniqueDataId, Stream updateContent, string uploadDataDescription = null, CancellationToken cancellationToken = default)
        {
            if (uniqueDataId == null)
            {
                throw new ArgumentNullException(nameof(uniqueDataId));
