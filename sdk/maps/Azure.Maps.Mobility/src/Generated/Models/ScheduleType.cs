...
namespace Azure.Maps.Mobility.Models
{
    ...
    public readonly partial struct ScheduleType : IEquatable<ScheduleType>
    {
        ...
        private const string ScheduledTimeValue = "scheduledTime";
        private const string RealTimeValue = "realTime";

        /// <summary> Returned when estimated time of arrival is based on real-time data. </summary>
        public static ScheduleType ScheduledTime { get; } = new ScheduleType(ScheduledTimeValue);
        /// <summary> Returned when estimated time of arrival is based on static data. </summary>
        public static ScheduleType RealTime { get; } = new ScheduleType(RealTimeValue);
        /// <summary> Determines if two <see cref="ScheduleType"/> values are the same. </summary>
