...
namespace Azure.Maps.WFS.Models
{
    ...
    public partial class ExtendedGeoJsonFeatureCollection : GeoJsonFeatureCollection
    {
        ...
        internal ExtendedGeoJsonFeatureCollection(IEnumerable<GeoJsonFeature> features) : base(features)
        {
            if (features == null)
            {
        ...
        internal ExtendedGeoJsonFeatureCollection(GeoJsonObjectType type, IReadOnlyList<GeoJsonFeature> features, string ontology, int? numberReturned, IReadOnlyList<WfsEndpointLink> links) : base(type, features)
        {
            Ontology = ontology;
