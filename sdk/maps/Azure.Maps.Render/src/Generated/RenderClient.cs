...
namespace Azure.Maps.Render
{
    ...
    public partial class RenderClient
    {
        ...
        /// <summary> Initializes a new instance of RenderClient for mocking. </summary>
        protected RenderClient()
        {
        }

        /// <summary> Initializes a new instance of RenderClient. </summary>
        ...
        public RenderClient(TokenCredential credential, Geography? geography = null, string xMsClientId = null, RenderClientOptions options = null)
        {
            if (credential == null)
            {
            ...
            RestClient = new RenderRestClient(_clientDiagnostics, _pipeline, geography, xMsClientId);
        }
        ...
        /// <param name="xMsClientId"> Specifies which account is intended for usage in conjunction with the Azure AD security model.  It represents a unique ID for the Azure Maps account and can be retrieved from the Azure Maps management  plane Account API. To use Azure AD security in Azure Maps see the following [articles](https://aka.ms/amauthdetails) for guidance. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public RenderClient(AzureKeyCredential credential, Geography? geography = null, string xMsClientId = null, RenderClientOptions options = null)
        {
            if (credential == null)
            {
                throw new ArgumentNullException(nameof(credential));
        ...
        /// <param name="geography"> This parameter specifies where the Azure Maps Creator resource is located.  Valid values are us and eu. </param>
        /// <param name="xMsClientId"> Specifies which account is intended for usage in conjunction with the Azure AD security model.  It represents a unique ID for the Azure Maps account and can be retrieved from the Azure Maps management  plane Account API. To use Azure AD security in Azure Maps see the following [articles](https://aka.ms/amauthdetails) for guidance. </param>
        internal RenderClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Geography? geography = null, string xMsClientId = null)
        {
            RestClient = new RenderRestClient(clientDiagnostics, pipeline, geography, xMsClientId);
        ...
        public virtual async Task<Response<Stream>> GetMapStaticImageAsync(RasterTileFormat format, StaticMapLayer? layer = null, MapImageStyle? style = null, int? zoom = null, string center = null, string bbox = null, int? height = null, int? width = null, string language = null, string view = null, IEnumerable<string> pins = null, IEnumerable<string> path = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapStaticImage");
            scope.Start();
            try
            {
                return await RestClient.GetMapStaticImageAsync(format, layer, style, zoom, center, bbox, height, width, language, view, pins, path, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Stream> GetMapStaticImage(RasterTileFormat format, StaticMapLayer? layer = null, MapImageStyle? style = null, int? zoom = null, string center = null, string bbox = null, int? height = null, int? width = null, string language = null, string view = null, IEnumerable<string> pins = null, IEnumerable<string> path = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapStaticImage");
            scope.Start();
            try
            {
                return RestClient.GetMapStaticImage(format, layer, style, zoom, center, bbox, height, width, language, view, pins, path, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="zoom">
        /// Zoom level for the desired tile. For _raster_ tiles, value must be in the range: 0-18 (inclusive). Terra raster tiles, values must be in the range 0-6 (inclusive). For _vector_ tiles, value must be in the range: 0-22 (inclusive).
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Stream>> GetMapTileAsync(TileFormat format, MapTileLayer layer, MapTileStyle style, int zoom, int xTileIndex, int yTileIndex, MapTileSize? tileSize = null, string language = null, string view = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapTile");
            scope.Start();
            try
            {
                return await RestClient.GetMapTileAsync(format, layer, style, zoom, xTileIndex, yTileIndex, tileSize, language, view, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Stream> GetMapTile(TileFormat format, MapTileLayer layer, MapTileStyle style, int zoom, int xTileIndex, int yTileIndex, MapTileSize? tileSize = null, string language = null, string view = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapTile");
            scope.Start();
            try
            {
                return RestClient.GetMapTile(format, layer, style, zoom, xTileIndex, yTileIndex, tileSize, language, view, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="zoom">
        /// Zoom level for the desired tile. Zoom value must be in the range: 0-20 (inclusive).
        /// 
        /// Please see [Zoom Levels and Tile Grid](https://docs.microsoft.com/en-us/azure/location-based-services/zoom-levels-and-tile-grid) for details.
        /// </param>
        /// <param name="xTileIndex">
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Stream>> GetMapStateTilePreviewAsync(int zoom, int xTileIndex, int yTileIndex, string statesetId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapStateTilePreview");
            scope.Start();
            try
            {
                return await RestClient.GetMapStateTilePreviewAsync(zoom, xTileIndex, yTileIndex, statesetId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="statesetId"> The stateset id. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Stream> GetMapStateTilePreview(int zoom, int xTileIndex, int yTileIndex, string statesetId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapStateTilePreview");
            scope.Start();
            try
            {
                return RestClient.GetMapStateTilePreview(zoom, xTileIndex, yTileIndex, statesetId, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GetCopyrightCaptionResult>> GetCopyrightCaptionAsync(TextFormat format, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightCaption");
            scope.Start();
            try
            {
        ...
        /// <param name="format"> Desired format of the response. Value can be either _json_ or _xml_. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GetCopyrightCaptionResult> GetCopyrightCaption(TextFormat format, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightCaption");
            scope.Start();
            try
        ...
        /// <param name="zoom">
        /// Zoom level for the desired tile. Zoom value must be in the range: 1-19 (inclusive).
        /// Please see [Zoom Levels and Tile Grid](https://docs.microsoft.com/en-us/azure/location-based-services/zoom-levels-and-tile-grid) for details.
        /// </param>
        /// <param name="xTileIndex">
        /// X coordinate of the tile on zoom grid. Value must be in the range [0, 2&lt;sup&gt;`zoom`&lt;/sup&gt; -1].
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<Stream>> GetMapImageryTileAsync(RasterTileFormat format, MapImageryStyle style, int zoom, int xTileIndex, int yTileIndex, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapImageryTile");
            scope.Start();
            try
            {
                return await RestClient.GetMapImageryTileAsync(format, style, zoom, xTileIndex, yTileIndex, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Stream> GetMapImageryTile(RasterTileFormat format, MapImageryStyle style, int zoom, int xTileIndex, int yTileIndex, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetMapImageryTile");
            scope.Start();
            try
            {
                return RestClient.GetMapImageryTile(format, style, zoom, xTileIndex, yTileIndex, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="format"> Desired format of the response. Value can be either _json_ or _xml_. </param>
        /// <param name="mincoordinates"> Minimum coordinates of bounding box in latitude longitude coordinate system. E.g. 52.41064,4.84228. </param>
        /// <param name="maxcoordinates"> Maximum coordinates of bounding box in latitude longitude coordinate system. E.g. 52.41064,4.84228. </param>
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GetCopyrightFromBoundingBoxResult>> GetCopyrightFromBoundingBoxAsync(TextFormat format, string mincoordinates, string maxcoordinates, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightFromBoundingBox");
            scope.Start();
            try
            {
                return await RestClient.GetCopyrightFromBoundingBoxAsync(format, mincoordinates, maxcoordinates, text, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GetCopyrightFromBoundingBoxResult> GetCopyrightFromBoundingBox(TextFormat format, string mincoordinates, string maxcoordinates, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightFromBoundingBox");
            scope.Start();
            try
            {
                return RestClient.GetCopyrightFromBoundingBox(format, mincoordinates, maxcoordinates, text, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GetCopyrightForTileResult>> GetCopyrightForTileAsync(TextFormat format, int zoom, int xTileIndex, int yTileIndex, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightForTile");
            scope.Start();
            try
            {
                return await RestClient.GetCopyrightForTileAsync(format, zoom, xTileIndex, yTileIndex, text, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GetCopyrightForTileResult> GetCopyrightForTile(TextFormat format, int zoom, int xTileIndex, int yTileIndex, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightForTile");
            scope.Start();
            try
            {
                return RestClient.GetCopyrightForTile(format, zoom, xTileIndex, yTileIndex, text, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GetCopyrightForWorldResult>> GetCopyrightForWorldAsync(TextFormat format, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightForWorld");
            scope.Start();
            try
            {
                return await RestClient.GetCopyrightForWorldAsync(format, text, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="text"> Yes/no value to exclude textual data from response. Only images and country names will be in response. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GetCopyrightForWorldResult> GetCopyrightForWorld(TextFormat format, IncludeText? text = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RenderClient.GetCopyrightForWorld");
            scope.Start();
            try
            {
                return RestClient.GetCopyrightForWorld(format, text, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
