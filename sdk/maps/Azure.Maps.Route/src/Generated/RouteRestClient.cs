...
namespace Azure.Maps.Route
{
    internal partial class RouteRestClient
    {
        ...
        internal HttpMessage CreatePostRouteMatrixRequest(ResponseFormat format, PostRouteMatrixRequestBody postRouteMatrixRequestBody, bool? waitForResults, ComputeTravelTimeFor? computeTravelTimeFor, SectionType? sectionType, DateTimeOffset? arriveAt, DateTimeOffset? departAt, int? vehicleAxleWeight, float? vehicleLength, float? vehicleHeight, float? vehicleWidth, int? vehicleMaxSpeed, int? vehicleWeight, WindingnessLevel? windingness, HillinessDegree? hilliness, TravelMode? travelMode, IEnumerable<RouteAvoidType> avoid, bool? traffic, RouteType? routeType, VehicleLoadType? vehicleLoadType)
        {
        ...
        public async Task<ResponseWithHeaders<RoutePostRouteMatrixHeaders>> PostRouteMatrixAsync(ResponseFormat format, PostRouteMatrixRequestBody postRouteMatrixRequestBody, bool? waitForResults = null, ComputeTravelTimeFor? computeTravelTimeFor = null, SectionType? sectionType = null, DateTimeOffset? arriveAt = null, DateTimeOffset? departAt = null, int? vehicleAxleWeight = null, float? vehicleLength = null, float? vehicleHeight = null, float? vehicleWidth = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, WindingnessLevel? windingness = null, HillinessDegree? hilliness = null, TravelMode? travelMode = null, IEnumerable<RouteAvoidType> avoid = null, bool? traffic = null, RouteType? routeType = null, VehicleLoadType? vehicleLoadType = null, CancellationToken cancellationToken = default)
        {
            ...
            var headers = new RoutePostRouteMatrixHeaders(message.Response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="postRouteMatrixRequestBody"/> is null. </exception>
        public ResponseWithHeaders<RoutePostRouteMatrixHeaders> PostRouteMatrix(ResponseFormat format, PostRouteMatrixRequestBody postRouteMatrixRequestBody, bool? waitForResults = null, ComputeTravelTimeFor? computeTravelTimeFor = null, SectionType? sectionType = null, DateTimeOffset? arriveAt = null, DateTimeOffset? departAt = null, int? vehicleAxleWeight = null, float? vehicleLength = null, float? vehicleHeight = null, float? vehicleWidth = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, WindingnessLevel? windingness = null, HillinessDegree? hilliness = null, TravelMode? travelMode = null, IEnumerable<RouteAvoidType> avoid = null, bool? traffic = null, RouteType? routeType = null, VehicleLoadType? vehicleLoadType = null, CancellationToken cancellationToken = default)
        {
            if (postRouteMatrixRequestBody == null)
            {
                throw new ArgumentNullException(nameof(postRouteMatrixRequestBody));
        ...
        internal HttpMessage CreateGetRouteMatrixRequest(string format)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal HttpMessage CreateGetRouteDirectionsRequest(TextFormat format, string query, int? maxAlternatives, AlternativeRouteType? alternativeType, int? minDeviationDistance, DateTimeOffset? arriveAt, DateTimeOffset? departAt, int? minDeviationTime, RouteInstructionsType? instructionsType, string language, bool? computeBestOrder, RouteRepresentation? routeRepresentation, ComputeTravelTimeFor? computeTravelTimeFor, int? vehicleHeading, string report, SectionType? sectionType, int? vehicleAxleWeight, float? vehicleWidth, float? vehicleHeight, float? vehicleLength, int? vehicleMaxSpeed, int? vehicleWeight, bool? vehicleCommercial, WindingnessLevel? windingness, HillinessDegree? hilliness, TravelMode? travelMode, IEnumerable<RouteAvoidType> avoid, bool? traffic, RouteType? routeType, VehicleLoadType? vehicleLoadType, VehicleEngineType? vehicleEngineType, float? constantSpeedConsumptionInLitersPerHundredkm, float? currentFuelInLiters, float? auxiliaryPowerInLitersPerHour, float? fuelEnergyDensityInMJoulesPerLiter, float? accelerationEfficiency, float? decelerationEfficiency, float? uphillEfficiency, float? downhillEfficiency, string constantSpeedConsumptionInkWhPerHundredkm, string currentChargeInkWh, string maxChargeInkWh, string auxiliaryPowerInkW)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            {
                uri.AppendQuery("computeBestOrder", computeBestOrder.Value, true);
            }
            if (routeRepresentation != null)
            {
                uri.AppendQuery("routeRepresentation", routeRepresentation.Value.ToString(), true);
            }
            if (computeTravelTimeFor != null)
            {
                uri.AppendQuery("computeTravelTimeFor", computeTravelTimeFor.Value.ToString(), true);
            ...
            if (report != null)
            {
                uri.AppendQuery("report", report, true);
            }
            if (sectionType != null)
            {
                uri.AppendQuery("sectionType", sectionType.Value.ToString(), true);
            ...
            {
                uri.AppendQuery("vehicleCommercial", vehicleCommercial.Value, true);
            }
            if (windingness != null)
            {
                uri.AppendQuery("windingness", windingness.Value.ToString(), true);
            ...
            {
                uri.AppendQuery("constantSpeedConsumptionInLitersPerHundredkm", constantSpeedConsumptionInLitersPerHundredkm.Value, true);
            }
            ...
            {
                uri.AppendQuery("fuelEnergyDensityInMJoulesPerLiter", fuelEnergyDensityInMJoulesPerLiter.Value, true);
            }
            ...
            {
                uri.AppendQuery("currentChargeInkWh", currentChargeInkWh, true);
            }
            if (maxChargeInkWh != null)
            {
                uri.AppendQuery("maxChargeInkWh", maxChargeInkWh, true);
            }
            if (auxiliaryPowerInkW != null)
            {
                uri.AppendQuery("auxiliaryPowerInkW", auxiliaryPowerInkW, true);
            }
            request.Uri = uri;
            if (xMsClientId != null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="query"/> is null. </exception>
        public Response<RouteDirectionsResponse> GetRouteDirections(TextFormat format, string query, int? maxAlternatives = null, AlternativeRouteType? alternativeType = null, int? minDeviationDistance = null, DateTimeOffset? arriveAt = null, DateTimeOffset? departAt = null, int? minDeviationTime = null, RouteInstructionsType? instructionsType = null, string language = null, bool? computeBestOrder = null, RouteRepresentation? routeRepresentation = null, ComputeTravelTimeFor? computeTravelTimeFor = null, int? vehicleHeading = null, string report = null, SectionType? sectionType = null, int? vehicleAxleWeight = null, float? vehicleWidth = null, float? vehicleHeight = null, float? vehicleLength = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, bool? vehicleCommercial = null, WindingnessLevel? windingness = null, HillinessDegree? hilliness = null, TravelMode? travelMode = null, IEnumerable<RouteAvoidType> avoid = null, bool? traffic = null, RouteType? routeType = null, VehicleLoadType? vehicleLoadType = null, VehicleEngineType? vehicleEngineType = null, float? constantSpeedConsumptionInLitersPerHundredkm = null, float? currentFuelInLiters = null, float? auxiliaryPowerInLitersPerHour = null, float? fuelEnergyDensityInMJoulesPerLiter = null, float? accelerationEfficiency = null, float? decelerationEfficiency = null, float? uphillEfficiency = null, float? downhillEfficiency = null, string constantSpeedConsumptionInkWhPerHundredkm = null, string currentChargeInkWh = null, string maxChargeInkWh = null, string auxiliaryPowerInkW = null, CancellationToken cancellationToken = default)
        {
            if (query == null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        internal HttpMessage CreatePostRouteDirectionsRequest(TextFormat format, string query, PostRouteDirectionsRequestBody postRouteDirectionsRequestBody, int? maxAlternatives, AlternativeRouteType? alternativeType, int? minDeviationDistance, int? minDeviationTime, RouteInstructionsType? instructionsType, string language, bool? computeBestOrder, RouteRepresentation? routeRepresentation, ComputeTravelTimeFor? computeTravelTimeFor, int? vehicleHeading, string report, SectionType? sectionType, DateTimeOffset? arriveAt, DateTimeOffset? departAt, int? vehicleAxleWeight, float? vehicleLength, float? vehicleHeight, float? vehicleWidth, int? vehicleMaxSpeed, int? vehicleWeight, bool? vehicleCommercial, WindingnessLevel? windingness, HillinessDegree? hilliness, TravelMode? travelMode, IEnumerable<RouteAvoidType> avoid, bool? traffic, RouteType? routeType, VehicleLoadType? vehicleLoadType, VehicleEngineType? vehicleEngineType, float? constantSpeedConsumptionInLitersPerHundredkm, float? currentFuelInLiters, float? auxiliaryPowerInLitersPerHour, float? fuelEnergyDensityInMJoulesPerLiter, float? accelerationEfficiency, float? decelerationEfficiency, float? uphillEfficiency, float? downhillEfficiency, string constantSpeedConsumptionInkWhPerHundredkm, string currentChargeInkWh, string maxChargeInkWh, string auxiliaryPowerInkW)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(postRouteDirectionsRequestBody);
            request.Content = content;
            return message;
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="query"/> or <paramref name="postRouteDirectionsRequestBody"/> is null. </exception>
        public Response<RouteDirectionsResponse> PostRouteDirections(TextFormat format, string query, PostRouteDirectionsRequestBody postRouteDirectionsRequestBody, int? maxAlternatives = null, AlternativeRouteType? alternativeType = null, int? minDeviationDistance = null, int? minDeviationTime = null, RouteInstructionsType? instructionsType = null, string language = null, bool? computeBestOrder = null, RouteRepresentation? routeRepresentation = null, ComputeTravelTimeFor? computeTravelTimeFor = null, int? vehicleHeading = null, string report = null, SectionType? sectionType = null, DateTimeOffset? arriveAt = null, DateTimeOffset? departAt = null, int? vehicleAxleWeight = null, float? vehicleLength = null, float? vehicleHeight = null, float? vehicleWidth = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, bool? vehicleCommercial = null, WindingnessLevel? windingness = null, HillinessDegree? hilliness = null, TravelMode? travelMode = null, IEnumerable<RouteAvoidType> avoid = null, bool? traffic = null, RouteType? routeType = null, VehicleLoadType? vehicleLoadType = null, VehicleEngineType? vehicleEngineType = null, float? constantSpeedConsumptionInLitersPerHundredkm = null, float? currentFuelInLiters = null, float? auxiliaryPowerInLitersPerHour = null, float? fuelEnergyDensityInMJoulesPerLiter = null, float? accelerationEfficiency = null, float? decelerationEfficiency = null, float? uphillEfficiency = null, float? downhillEfficiency = null, string constantSpeedConsumptionInkWhPerHundredkm = null, string currentChargeInkWh = null, string maxChargeInkWh = null, string auxiliaryPowerInkW = null, CancellationToken cancellationToken = default)
        {
            if (query == null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        internal HttpMessage CreateGetRouteRangeRequest(TextFormat format, string query, float? fuelBudgetInLiters, float? energyBudgetInkWh, float? timeBudgetInSec, float? distanceBudgetInMeters, DateTimeOffset? departAt, RouteType? routeType, bool? traffic, IEnumerable<RouteAvoidType> avoid, TravelMode? travelMode, HillinessDegree? hilliness, WindingnessLevel? windingness, int? vehicleAxleWeight, float? vehicleWidth, float? vehicleHeight, float? vehicleLength, int? vehicleMaxSpeed, int? vehicleWeight, bool? vehicleCommercial, VehicleLoadType? vehicleLoadType, VehicleEngineType? vehicleEngineType, float? constantSpeedConsumptionInLitersPerHundredkm, float? currentFuelInLiters, float? auxiliaryPowerInLitersPerHour, float? fuelEnergyDensityInMJoulesPerLiter, float? accelerationEfficiency, float? decelerationEfficiency, float? uphillEfficiency, float? downhillEfficiency, string constantSpeedConsumptionInkWhPerHundredkm, string currentChargeInkWh, string maxChargeInkWh, string auxiliaryPowerInkW)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<GetRouteRangeResponse>> GetRouteRangeAsync(TextFormat format, string query, float? fuelBudgetInLiters = null, float? energyBudgetInkWh = null, float? timeBudgetInSec = null, float? distanceBudgetInMeters = null, DateTimeOffset? departAt = null, RouteType? routeType = null, bool? traffic = null, IEnumerable<RouteAvoidType> avoid = null, TravelMode? travelMode = null, HillinessDegree? hilliness = null, WindingnessLevel? windingness = null, int? vehicleAxleWeight = null, float? vehicleWidth = null, float? vehicleHeight = null, float? vehicleLength = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, bool? vehicleCommercial = null, VehicleLoadType? vehicleLoadType = null, VehicleEngineType? vehicleEngineType = null, float? constantSpeedConsumptionInLitersPerHundredkm = null, float? currentFuelInLiters = null, float? auxiliaryPowerInLitersPerHour = null, float? fuelEnergyDensityInMJoulesPerLiter = null, float? accelerationEfficiency = null, float? decelerationEfficiency = null, float? uphillEfficiency = null, float? downhillEfficiency = null, string constantSpeedConsumptionInkWhPerHundredkm = null, string currentChargeInkWh = null, string maxChargeInkWh = null, string auxiliaryPowerInkW = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetRouteRangeRequest(format, query, fuelBudgetInLiters, energyBudgetInkWh, timeBudgetInSec, distanceBudgetInMeters, departAt, routeType, traffic, avoid, travelMode, hilliness, windingness, vehicleAxleWeight, vehicleWidth, vehicleHeight, vehicleLength, vehicleMaxSpeed, vehicleWeight, vehicleCommercial, vehicleLoadType, vehicleEngineType, constantSpeedConsumptionInLitersPerHundredkm, currentFuelInLiters, auxiliaryPowerInLitersPerHour, fuelEnergyDensityInMJoulesPerLiter, accelerationEfficiency, decelerationEfficiency, uphillEfficiency, downhillEfficiency, constantSpeedConsumptionInkWhPerHundredkm, currentChargeInkWh, maxChargeInkWh, auxiliaryPowerInkW);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        GetRouteRangeResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = GetRouteRangeResponse.DeserializeGetRouteRangeResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="query"/> is null. </exception>
        public Response<GetRouteRangeResponse> GetRouteRange(TextFormat format, string query, float? fuelBudgetInLiters = null, float? energyBudgetInkWh = null, float? timeBudgetInSec = null, float? distanceBudgetInMeters = null, DateTimeOffset? departAt = null, RouteType? routeType = null, bool? traffic = null, IEnumerable<RouteAvoidType> avoid = null, TravelMode? travelMode = null, HillinessDegree? hilliness = null, WindingnessLevel? windingness = null, int? vehicleAxleWeight = null, float? vehicleWidth = null, float? vehicleHeight = null, float? vehicleLength = null, int? vehicleMaxSpeed = null, int? vehicleWeight = null, bool? vehicleCommercial = null, VehicleLoadType? vehicleLoadType = null, VehicleEngineType? vehicleEngineType = null, float? constantSpeedConsumptionInLitersPerHundredkm = null, float? currentFuelInLiters = null, float? auxiliaryPowerInLitersPerHour = null, float? fuelEnergyDensityInMJoulesPerLiter = null, float? accelerationEfficiency = null, float? decelerationEfficiency = null, float? uphillEfficiency = null, float? downhillEfficiency = null, string constantSpeedConsumptionInkWhPerHundredkm = null, string currentChargeInkWh = null, string maxChargeInkWh = null, string auxiliaryPowerInkW = null, CancellationToken cancellationToken = default)
        {
            if (query == null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        internal HttpMessage CreatePostRouteDirectionsBatchRequest(ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue(postRouteDirectionsBatchRequestBody);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateGetRouteDirectionsBatchRequest(string format)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreatePostRouteDirectionsBatchSyncRequest(ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="postRouteDirectionsBatchRequestBody"/> is null. </exception>
        public async Task<Response<RouteDirectionsBatchResponse>> PostRouteDirectionsBatchSyncAsync(ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody, CancellationToken cancellationToken = default)
        {
            if (postRouteDirectionsBatchRequestBody == null)
            {
                throw new ArgumentNullException(nameof(postRouteDirectionsBatchRequestBody));
            ...
            using var message = CreatePostRouteDirectionsBatchSyncRequest(format, postRouteDirectionsBatchRequestBody);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        RouteDirectionsBatchResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = RouteDirectionsBatchResponse.DeserializeRouteDirectionsBatchResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="postRouteDirectionsBatchRequestBody"/> is null. </exception>
        public Response<RouteDirectionsBatchResponse> PostRouteDirectionsBatchSync(ResponseFormat format, BatchRequestBody postRouteDirectionsBatchRequestBody, CancellationToken cancellationToken = default)
        {
            if (postRouteDirectionsBatchRequestBody == null)
            {
                throw new ArgumentNullException(nameof(postRouteDirectionsBatchRequestBody));
