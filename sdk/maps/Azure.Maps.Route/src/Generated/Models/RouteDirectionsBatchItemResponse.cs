...
namespace Azure.Maps.Route.Models
{
    ...
    public partial class RouteDirectionsBatchItemResponse : RouteDirectionsResponse
    {
        ...
        internal RouteDirectionsBatchItemResponse(string formatVersion, IReadOnlyList<RouteDirectionsResult> routes, IReadOnlyList<RouteOptimizedWaypoint> optimizedWaypoints, RouteResponseReport report, ErrorDetail error) : base(formatVersion, routes, optimizedWaypoints, report)
        {
            Error = error;
        }
