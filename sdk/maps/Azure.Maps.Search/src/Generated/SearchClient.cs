...
namespace Azure.Maps.Search
{
    ...
    public partial class SearchClient
    {
        ...
        public SearchClient(TokenCredential credential, Geography? geography = null, string xMsClientId = null, SearchClientOptions options = null)
        {
            if (credential == null)
            {
        ...
        /// <param name="xMsClientId"> Specifies which account is intended for usage in conjunction with the Azure AD security model.  It represents a unique ID for the Azure Maps account and can be retrieved from the Azure Maps management  plane Account API. To use Azure AD security in Azure Maps see the following [articles](https://aka.ms/amauthdetails) for guidance. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public SearchClient(AzureKeyCredential credential, Geography? geography = null, string xMsClientId = null, SearchClientOptions options = null)
        {
            if (credential == null)
            {
                throw new ArgumentNullException(nameof(credential));
        ...
        internal SearchClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Geography? geography = null, string xMsClientId = null, string apiVersion = "1.0")
        {
